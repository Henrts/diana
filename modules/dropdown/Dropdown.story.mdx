...
<table width="100%">
  ...
  <tbody>
    <tr>
      ...
      <td>
        The list of options to be presented. This is a generic type, so it may contain additional
        attributes.
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>text (optional)</td>
      <th>string</th>
      <td>A text to be shown on the header to represent the current selection.</td>
    </tr>
    <tr>
...
If you wish to allow the user to select multiple items use the MultipleDropdown component.
