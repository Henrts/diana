...
<table width="100%">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        The Tab's index.
        <br /> This prop should not be passed manually, as it is injected by the Tab's <i>
          TabGroup
        </i>.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>string</td>
      <td>
        The Tab compares <i>selectedTab</i> to its own index to determine whether it is selected.{" "}
        <br /> This prop should not be passed manually, as it is injected by the Tab's{" "}
        <i>TabGroup</i>.
      </td>
    </tr>
    <tr>
...
<table width="100%">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>function</td>
      <td>
        Callback that is passed on to each child <i>Tab</i> and invoked whenever a <i>Tab</i> inside
        the <i>TabGroup</i> is clicked on (given
    ...
    <tr>
      ...
      <td>boolean</td>
      <td>It will animate the element when selecting a tab</td>
    </tr>
  </tbody>
</table>
...
<table width="100%">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td></td>
      <td>
        Style of the <i>section</i> element that contains the selected tab's content (
        <i>children</i>)
      </td>
    </tr>
  </tbody>
