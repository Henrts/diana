...
<table width="100%">
    ...
    <tbody>
        <tr>
            <td>schema</td>
            <td>
                If you would like to centralize your validation rules with
        ...
        <tr>
            <td>onSubmit</td>
            <td>
                Callback for a successful (no errors) submission of the form
            </td>
        </tr>
        <tr>
            <td>defaultValues (optional)</td>
            <td>
                Object of values following the schema rules to initialize the
                form
            </td>
        </tr>
        <tr>
            <td>clearOnSubmit (default: true)</td>
            <td>
                Resets the form to its initial state (uses defaultValues if
                specified)
            </td>
        </tr>
    </tbody>
...
<table width="100%">
    ...
    <tbody>
        <tr>
            ...
            <td></td>
            <td>
                This style affects the main container element that contains all
                the children fields and inputs of the form
            </td>
        </tr>
    </tbody>
</table>
