...
<Preview>
    <Story name="IconChip">
        ...
        >
            ...
            <BaseChip
                renderRightIcon={() => <ChipIcon type="right" name="add" />}
            >
                with right icon
            </BaseChip>
            <BaseChip
...
<table width="100%">
    ...
    <tbody>
        <tr>
            <td>type</td>
            <td>
                Can be default, success, warning or danger and will set color of
                the chip
            </td>
        </tr>
    </tbody>
...
<table width="100%">
    ...
    <tbody>
        <tr>
            <td>onClose</td>
            <td>
                Callback when the chip is closed by clicking on the right icon
            </td>
        </tr>
    </tbody>
</table>
...
<table width="100%">
    ...
    <tbody>
        ...
        <tr>
            <td>displayFn</td>
            <td>
                Function that will change how the item is displayed. Used in
                case of objects. default: (item:T) => item
            </td>
        </tr>
        <tr>
            <td>onDismissChip</td>
