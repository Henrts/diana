...
<table width="100%">
    ...
    <tbody>
        <tr>
            <td>label</td>
            <td>
                This props enables a span element that, by default, slides to
                the fieldset/border of the input when in focus.
            </td>
        </tr>
        <tr>
            <td>hasError</td>
            <td>
                hasError signals to the TextInput component to activate the
                necessary styles to customize an error text input component
            </td>
        </tr>
    </tbody>
</table>
...
<table width="100%">
    ...
    <tbody>
        <tr>
            ...
            <td></td>
            <td>
                This style affects the main fieldset element that contains the
                input element. Apply custom border styles here
            </td>
        </tr>
        <tr>
            <td></td>
        ...
        <tr>
            ...
            <td>&.active</td>
            <td>
                Style to apply to fieldset element when component has content
                (is active)
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td></td>
            <td>
                Style of span element containing text defined by the label prop
            </td>
        </tr>
        <tr>
            <td></td>
            <td>&.active</td>
            <td>
                Style of span element containing label text on active Text Input
            </td>
        </tr>
        <tr>
            <td></td>
            <td>&.focus</td>
            <td>
                Style of span element containing label text on focused Text
                Input
            </td>
        </tr>
        <tr>
