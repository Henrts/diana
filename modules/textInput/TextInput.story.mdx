...
<table width="100%">
  ...
  <tbody>
    ...
    <tr>
      <td>prefixIcon</td>
      <td>
        prefixIcon is a string that will render an Icon before the text input
      </td>
    </tr>
    <tr>
      <td>suffixIcon</td>
      <td>
        suffixIcon is a string that will render an Icon after the text input
      </td>
    </tr>
  </tbody>
</table>
...
<table width="100%">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>&.active</td>
      <td>
        Style to apply to fieldset element when component has content (is
        active)
      </td>
    </tr>
    <tr>
