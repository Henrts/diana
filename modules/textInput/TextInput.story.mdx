...
<table width="100%">
  ...
  <tbody>
    <tr>
      <td>label</td>
      <td>
        This props enables a span element that, by default, slides to the fieldset/border of the
        input when in focus.
      </td>
    </tr>
    <tr>
      <td>hasError</td>
      <td>
        hasError signals to the TextInput component to activate the necessary styles to customize an
        error text input component
      </td>
    </tr>
    <tr>
      <td>prefixIcon</td>
      <td>prefixIcon is a string that will render an Icon before the text input</td>
    </tr>
    <tr>
      <td>suffixIcon</td>
      <td>suffixIcon is a string that will render an Icon after the text input</td>
    </tr>
  </tbody>
</table>
...
<Preview>
  <Story name="With Prefix / Suffix ">
    <TextInput label="User Input" prefixIcon="chart" suffixIcon={<span>€</span>} />
  </Story>
</Preview>
...
<Preview>
  <Story name="Customizing Text With Hint">
    <ErrorTextInput label="User Input" hint="this is helpful" />
  </Story>
</Preview>
...
<table width="100%">
  ...
  <tbody>
    <tr>
      ...
      <td></td>
      <td>
        This style affects the main fieldset element that contains the input element. Apply custom
        border styles here
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td></td>
      <td>&.active</td>
      <td>Style to apply to fieldset element when component has content (is active)</td>
    </tr>
    <tr>
      <td></td>
      <td>&.focus</td>
    ...
    <tr>
      <td>inputContainer</td>
      <td></td>
      <td>Container with input and prefix/suffix</td>
    </tr>
    <tr>
      <td>input</td>
      <td></td>
    ...
    <tr>
      <td>labelWithPrefix</td>
      <td></td>
      <td>Style of label if has a prefix before</td>
    </tr>
    <tr>
      <td>helperLabel</td>
      <td></td>
      <td>Style of the helper text, both for error or hint</td>
    </tr>
    <tr>
      <td>errorLabel</td>
      <td></td>
      <td>Style of the error helper label</td>
    </tr>
    <tr>
      <td>hintLabel</td>
      <td></td>
      <td>Style of the hint helper label</td>
    </tr>
    <tr>
      <td></td>
      <td>&.active</td>
    ...
    <tr>
      <td>prefixIcon</td>
      <td></td>
      <td>Style of icon as prefix</td>
    </tr>
    <tr>
      <td>suffixIcon</td>
      <td></td>
      <td>Style of icon as suffix</td>
    </tr>
  </tbody>
</table>
