...
export const Spacing = () => {
    return <div className="typography-spacing">
...
export const SquishSpacing = () => {
    return <div className="typography-spacing typography-spacing-inset">
...
export const SpacingDiv: React.FC<IProps> =  ({ margin, children }) => {
    ...
    return numSpac > 20 ? (
        ...
        <div style={{border: `${spac} solid steelblue`, width: 200 - numSpac * 2, height: 200 - numSpac * 2}}>
...
const SquishSpacingDiv: React.FC<IProps> =  ({ margin, children }) => {
    ...
    return <div className="spacing-outside" style={{padding: `${spacTop} ${spacLeft}`, backgroundColor: "steelblue", width: 200 - numSpacLeft * 2, height: 80 - numSpacTop * 2}}>
