...
Using an extended CloseableChip

<Preview>
  <ChipList
    list={["test", "test2", "test3"]}
    Chip={CloseableChip.extendStyles(() => ({
      chip: { backgroundColor: "steelblue" }
    }))}
  />
</Preview>
...
<Preview>
  <Story name="ChipInput">
    <ChipInput onChange={e => console.log(e)} />
  </Story>
</Preview>
...
With initial values and a placeholder. This one enables duplicates.
...
With a different extended CloseableChip.
