...
import { TextInputCustomBorder, TextInputErrorBorder, TextInputLabelToOutside } from "./TextInput.story"
...
<table width="100%">
    ...
    <tbody>
        <tr>
            <td>label</td>
            <td>This props enables a span element that, by default, slides to the fieldset/border of the input when in focus. </td>
        </tr>
        <tr>
            <td>hasError</td>
            <td>hasError signals to the TextInput component to activate the necessary styles to customize an error text input component</td>
        </tr>
    </tbody>
</table>
...
<table width="100%">
    ...
    <tbody>
        <tr>
            <td>fieldset</td>
            <td>This style affects the main fieldset element that contains the input element. Apply custom border styles here</td>
        </tr>
        <tr>
            <td>fieldsetError</td>
        ...
        <tr>
            <td>labelActive</td>
            <td>Style applied to label when Component has a value</td>
        </tr>
        <tr>
            <td>labelFocus</td>
            <td>Style applied to label when Component is focused</td>
        </tr>
        <tr>
            <td>legend</td>
