...
The `NotificationStack` receives an array of notifications and handles their display. Through the theme, the aninmations applied to showing and hiding a notification can be configured.
